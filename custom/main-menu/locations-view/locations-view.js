...
customization.registerMainMenuItem({
    label: 'Consultar ubicaciones de Clientes',
                            ...
                            if(data.records[i].gps_latitud_c !="" && data.records[i].gps_longitud_c != ""){
                               ...
                               var icono='img/icon-negro_.png';
                                ...
                                marker.on(plugin.google.maps.event.MARKER_CLICK, function(markers, info) {
                                    ...
                                    var urlImage='';
                                    if(definicionCuenta.tct_fotoinmueble_c != "" && definicionCuenta.tct_fotoinmueble_c !=null){
                                        urlImage=self.generarURLImage('Accounts', definicionCuenta.id, 'tct_fotoinmueble_c',definicionCuenta.tct_fotoinmueble_c);
